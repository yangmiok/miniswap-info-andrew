...
async function getBulkPairData(pairList, ethPrice) {
  ...
  const utcOneWeekBack = utcCurrentTime
    ...
    .startOf('minute')
    .unix()
  let oneDayBlock = await getBlockFromTimestamp(utcOneDayBack) //to get 1day block data
  let twoDayBlock = await getBlockFromTimestamp(utcTwoDaysBack) // to get 2days block data
  let oneWeekBlock = await getBlockFromTimestamp(utcOneWeekBack) // to get 7days block data
  ...
  try {
    ...
    // to use day 1,2,7 data that consist an array as paramter to fetch data step by step
