        ...
        <RowBetween mt={20} style={{ flexWrap: 'wrap' }}>
          ...
          >
            <Link external href={getPoolLink(token0?.id, token1?.id)}>
              <ButtonDark color={backgroundColor} style={{ fontSize: 16, fontWeight: 400 }}>+ Add Liquidity</ButtonDark>
            </Link>
            <Link external href={getSwapLink(token0?.id, token1?.id)}>
              <ButtonLight color={'white'} style={{ background: '#E91864', fontSize: 16, fontWeight: 400 }} ml={'.5rem'} mr={below1080 && '.5rem'}>Trade</ButtonLight>
              {/* <ButtonLight ml={'.5rem'} mr={below1080 && '.5rem'} color={backgroundColor}>
                Trade
              </ButtonLight> */}
            </Link>
          </RowFixed>
          ...
          <>
            ...
            <PanelWrapper style={{ marginTop: '1.5rem' }}>
              ...
              <Panel style={{ gridColumn: below1080 ? '1' : '2/4', gridRow: below1080 ? '' : '1/6' }}>
                <PairChart address={pairAddress} color='#6848C1' />
              </Panel>
            </PanelWrapper>
            ...
            >
              <TokenDetailsLayout>
                ...
                <ButtonDark color={backgroundColor}>
                  <Link color="#ffffff" external href={'https://etherscan.io/address/' + pairAddress}>
                    View on Etherscan ↗
                  </Link>
                </ButtonDark>
              </TokenDetailsLayout>
