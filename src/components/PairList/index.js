        ...
        >
          <DataText area="name" fontWeight="500">
            ...
            <DoubleTokenLogo
              ...
              margin={!below740}
            />
            <CustomLink style={{ marginLeft: '20px', whiteSpace: 'nowrap' }} to={'/pair/' + pairAddress} color={"#6848C1"}>
              ...
              <Flex area="pool" justifyContent="flex-end" alignItems="center">
                ...
                <Flex area="pool" justifyContent="flex-end" alignItems="center">
                  <Link color={color} external href={getPoolLink(pairData.token0?.id, pairData.token1?.id)}>
                    <ButtonDark color={color} style={{ marginRight: '10px', fontSize: 16, fontWeight: 400 }}>
                      + Add Liquidity
                  </ButtonDark>
                  </Link>
                  <Link color={'white'} external href={getSwapLink(pairData.token0?.id, pairData.token1?.id)}>
                    <ButtonLight color={'white'} style={{ background: '#E91864', fontSize: 16, fontWeight: 400 }}>Trade</ButtonLight>
                  </Link>
                </Flex>
              ))}
        </DashGrid>
